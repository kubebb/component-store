...
class ComponentsManagementInstallDetail$$Page extends React.Component {
  ...
  form(name) {
    return this.$(name || 'formily_detail')?.formRef?.current?.form;
  }
  ...
  initForms(v, form) {
    const images = this.props.useGetComponentplan?.data?.componentplan?.images;
    v =
      v ||
      (images && {
        images,
  ...
  async loadDetail(record) {
    ...
    this.initForms(componentplan, 'formily_detail_model');
  }
    ...
    return (
      <Page>
        <Drawer
          ...
          className="componentsInstallDetailNoEdit"
          destroyOnClose={true}
          mask={true}
          maskClosable={false}
          onClose={function () {
            ...
            <Col __component_name="Col" span={24}>
              ...
              <Descriptions
                ...
                items={[
                  {
                    children: (
                      <Row __component_name="Row" style={{ width: '100%' }} wrap={true}>
                        <Col __component_name="Col" span={24}>
                          <Typography.Text
                            __component_name="Typography.Text"
                            disabled={false}
                  ...
                  },
                  {
                    children: (
                      <FormilyForm
                        ...
                        ref={this._refsManager.linkRef('formily_detail_model')}
                      >
                        <FormilyArrayCards
                        ...
                        >
                          <Space __component_name="Space" align="center" direction="horizontal">
                            <FormilySelect
                              ...
                              decoratorProps={{ 'x-decorator-props': { labelEllipsis: true } }}
                              fieldProps={{ name: 'image', title: '', 'x-validator': [] }}
                              style={{ width: '170px' }}
                            />
                            <Space
                            ...
                            >
                              ...
                              <FormilyInput
                                ...
                                componentProps={{ 'x-component-props': { placeholder: '新域名' } }}
                                decoratorProps={{ 'x-decorator-props': { labelEllipsis: true } }}
                                fieldProps={{ name: 'newRegistry', title: '', 'x-validator': [] }}
                              />
                              <FormilyInput
                                __component_name="FormilyInput"
                                componentProps={{
                                ...
                                decoratorProps={{ 'x-decorator-props': { labelEllipsis: true } }}
                                fieldProps={{ name: 'newPath', title: '', 'x-validator': [] }}
                              />
                              <FormilyInput
                                __component_name="FormilyInput"
                                componentProps={{
                                  'x-component-props': {
                                    placeholder:
                                      this.i18n('i18n-1gb2xaxt') /* 新镜像名称(非必填) */,
                                  },
                                }}
                                decoratorProps={{ 'x-decorator-props': { labelEllipsis: true } }}
                              ...
                              <FormilyInput
                                ...
                                componentProps={{
                                  'x-component-props': {
                                    placeholder:
                                      this.i18n('i18n-9u5a4f3f') /* 新tag/新digest(非必填) */,
                                  },
                                }}
                                decoratorProps={{ 'x-decorator-props': { labelEllipsis: true } }}
          ...
          <Alert
            ...
            message={[
              !!__$$eval(
                ...
                <Row __component_name="Row" gutter={[0, 0]} wrap={true} key="node_oclma60ftb1">
                  <Col __component_name="Col" span={24}>
                    <Space __component_name="Space" align="center" direction="horizontal">
                      <Typography.Text
                        __component_name="Typography.Text"
              ...
              <Row __component_name="Row" gutter={[0, 0]} wrap={true} key="node_oclmeavsua36">
                {!!__$$eval(
                  () =>
                    this.props.useGetComponentplanHistory?.data?.componentplan?.status ===
                    'Installing'
          ...
          <Col __component_name="Col" span={24}>
            ...
            {!!false && (
              <Tag
                ...
                closable={false}
                color="default"
                style={{ borderRadius: '0', marginTop: '-5px', position: 'relative' }}
              >
                          ...
                          },
                          {
                            children: (
                              <FormilyForm
                                ...
                                formHelper={{ autoFocus: true }}
                                ref={this._refsManager.linkRef('formily_detail')}
                              >
                                <FormilyArrayCards
                                  __component_name="FormilyArrayCards"
                                  decoratorProps={{ 'x-decorator-props': { labelEllipsis: true } }}
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      <FormilyInput
                                        __component_name="FormilyInput"
                                        componentProps={{
                                          'x-component-props': { placeholder: '新域名' },
                                        }}
                                        decoratorProps={{
                                          'x-decorator-props': { labelEllipsis: true },
                                        }}
