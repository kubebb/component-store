...
class ComponentsMarket$$Page extends React.Component {
  ...
  getSearchPlaceholder() {
    const i18nKey = {
      chartName: 'i18n-83r28a2h',
      repository: 'i18n-q3xp5myo',
  ...
  handleQueryChange() {
    ...
    if (this.state.type && this.state.type !== 'ALL') {
      params.classification = this.state.type;
    }
    if (this.state.type && this.state.type === 'ALL') {
                    ...
                    >
                      <Container __component_name="Container" color="colorTextDescription">
                        <AntdIconQuestionCircleOutlined
                          ...
                          style={{ color: '', marginLeft: '3px', position: 'relative' }}
                        />
                      </Container>
                    </Tooltip>
                  </Col>
                    ...
                    <Col __component_name="Col">
                      <Space __component_name="Space" align="center" direction="horizontal">
                        ...
                        <Radio.Group
                          ...
                          disabled={false}
                          onChange={function () {
                            return this.handleSourceChange.apply(
                              this,
                              Array.prototype.slice.call(arguments).concat([])
                            );
                          }.bind(this)}
                          options={__$$eval(() =>
                            [
                              ...
                              this.utils.getComponentSource(this)?.map(item => ({
                                ...item,
                                label: item.text,
                              }))
                            )
                    ...
                    <Col __component_name="Col">
                      ...
                      >
                        <Typography.Text
                          ...
                          ellipsis={true}
                          strong={false}
                          style={{ fontSize: '', paddingTop: '12px' }}
                        >
                        ...
                        <List.Item ref={this._refsManager.linkRef('list.item-e9063858')}>
                          ...
                          >
                            ...
                            <Row __component_name="Row" gutter={[0, 0]} wrap={true}>
                              ...
                              <Col __component_name="Col" span={24}>
                                <Row __component_name="Row" gutter={[0, 20]} wrap={true}>
                                  <Col __component_name="Col" span={24}>
                                    <Descriptions
                                      ...
                                      colon={false}
                                      column={1}
                                      contentStyle={{ display: 'grid', flex: '1', padding: '0' }}
                                      id=""
                                      items={[
                                        {
                                          children: (
...
const PageWrapper = (props = {}) => {
  ...
  return (
    <DataProvider
      ...
      render={dataProps => (
        <ComponentsMarket$$Page {...props} {...dataProps} self={self} appHelper={appHelper} />
      )}
    />
  );
};
