...
export const COMPONENT_CRD_SPEC = {
  kind: 'Component',
...
const { kind, group, version, plural } = COMPONENT_CRD_SPEC;
const DEFAULT_BODY = {
  kind,
...
export class Component {
   ...
   * @param {CRD.Component} body Component 对象
   * @param {CreateOptions} [options] 可选配置项
   */
  create(namespace: string, body: CRD.Component, options?: CreateOptions) {
   ...
   * 替换指定的 Component
   *
   * @param {string} name Component 名称
   * @param {string} namespace 命名空间
   * @param {CRD.Component} body Component 对象
   * @param {CreateOptions} [options] 可选配置项
   */
  replace(name: string, namespace: string, body: CRD.Component, options?: CreateOptions) {
  ...
  /**
   * 部分更新指定的 Component (JSON Patch)
   *
   * @param {string} name Component 名称
   * @param {string} namespace 命名空间
   * @param {JsonPatchOp[]} body Component 对象
  ...
  /**
   * 部分更新指定的 Component (Merge Patch)
   *
   * @param {string} name Component 名称
   * @param {string} namespace 命名空间
   * @param {object} body Component 对象
   * @param {PatchOptions} [options] 可选配置项
   */
  ...
  /**
   * 部分更新指定的 Component (Strategic Merge Patch)
   *
   * @param {string} name Component 名称
   * @param {string} namespace 命名空间
   * @param {object} body Component 对象
  ...
  /**
   * 根据名称获取 Component 详情 (指定 namespace 下)
   *
   * @param {string} name Component 名称
   * @param {string} namespace 命名空间
