...
export class LLM {
   ...
   * @param {CRD.LLM} body LLM 对象
   * @param {CreateOptions} [options] 可选配置项
   */
  create(namespace: string, body: CRD.LLM, options?: CreateOptions) {
   ...
   * 替换指定的 LLM
   *
   * @param {string} name LLM 名称
   * @param {string} namespace 命名空间
   * @param {CRD.LLM} body LLM 对象
   * @param {CreateOptions} [options] 可选配置项
   */
  replace(name: string, namespace: string, body: CRD.LLM, options?: CreateOptions) {
  ...
  /**
   * 部分更新指定的 LLM (JSON Patch)
   *
   * @param {string} name LLM 名称
   * @param {string} namespace 命名空间
   * @param {JsonPatchOp[]} body LLM 对象
  ...
  /**
   * 部分更新指定的 LLM (Merge Patch)
   *
   * @param {string} name LLM 名称
   * @param {string} namespace 命名空间
   * @param {object} body LLM 对象
   * @param {PatchOptions} [options] 可选配置项
   */
  ...
  /**
   * 部分更新指定的 LLM (Strategic Merge Patch)
   *
   * @param {string} name LLM 名称
   * @param {string} namespace 命名空间
   * @param {object} body LLM 对象
