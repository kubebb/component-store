...
const { kind, group, version, plural } = PROMPT_CRD_SPEC;
const DEFAULT_BODY = {
  kind,
...
export class Prompt {
   ...
   * @param {CRD.Prompt} body Prompt 对象
   * @param {CreateOptions} [options] 可选配置项
   */
  create(namespace: string, body: CRD.Prompt, options?: CreateOptions) {
   ...
   * @param {CreateOptions} [options] 可选配置项
   */
  replace(name: string, namespace: string, body: CRD.Prompt, options?: CreateOptions) {
  ...
  /**
   * 部分更新指定的 Prompt (JSON Patch)
   *
   * @param {string} name Prompt 名称
   * @param {string} namespace 命名空间
   * @param {JsonPatchOp[]} body Prompt 对象
  ...
  /**
   * 部分更新指定的 Prompt (Merge Patch)
   *
   * @param {string} name Prompt 名称
   * @param {string} namespace 命名空间
   * @param {object} body Prompt 对象
   * @param {PatchOptions} [options] 可选配置项
   */
  ...
  /**
   * 部分更新指定的 Prompt (Strategic Merge Patch)
   *
   * @param {string} name Prompt 名称
   * @param {string} namespace 命名空间
   * @param {object} body Prompt 对象
  ...
  /**
   * 根据名称获取 Prompt 详情 (指定 namespace 下)
   *
   * @param {string} name Prompt 名称
   * @param {string} namespace 命名空间
